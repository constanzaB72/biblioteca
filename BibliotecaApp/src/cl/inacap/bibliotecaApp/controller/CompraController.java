...
public class CompraController {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (cantidadFilas != 0) {
				...
				for (int i = 0; i < cantidadFilas; i++) {
					...
					// }while(cont<(Integer)(compraFrame.getTableLibros().getModel().getValueAt(i,
					// 3)));
	...
	class AgregarListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			/*
			 * for (int c = 0; c < compraFrame.getTableLibros().getColumnCount()-2; c++) {
			 * Class<?> col_class = compraFrame.getTableLibros().getColumnClass(c);
			 * compraFrame.getTableLibros().setDefaultEditor(col_class, null); // remove
			 * editor }
			 */
